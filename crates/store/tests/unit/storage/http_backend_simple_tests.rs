...
fn test_http_backend_url_validation_127_blocked() {
    ...
    let result = HttpBackend::new("http://127.0.0.1:8080/test.bin", false);
    assert!(
        result.is_err(),
...
fn test_http_backend_url_validation_private_ip_10() {
    ...
    let result = HttpBackend::new("http://10.0.0.1/test.bin", false);
...
fn test_http_backend_url_validation_private_ip_192() {
    ...
    let result = HttpBackend::new("http://192.168.1.1/test.bin", false);
...
fn test_http_backend_url_validation_private_ip_172() {
    ...
    let result = HttpBackend::new("http://172.16.0.1/test.bin", false);
...
fn test_http_backend_invalid_url_scheme() {
    ...
    let result = HttpBackend::new("ftp://example.com/test.bin", true);
...
fn test_http_backend_missing_path() {
    ...
    let _result = HttpBackend::new("http://example.com", true);
...
fn test_http_backend_https_scheme() {
    ...
    let result = HttpBackend::new("https://example.com/test.bin", true);
