//! Implementation of the `strata build` command.
//!
...
///
/// **Architectural intent:** Maps the high-level `build` arguments (source, profile)
/// into the lower-level parameters required by `create::run`.
pub fn run(
    source: PathBuf,
