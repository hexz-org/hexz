//! Common types, configuration, and constants shared by Strata crates.
//!
...
/// Configuration loading and runtime parameter management for Strata tools.
///
...
/// Shared constants and format parameters for the Strata ecosystem.
///
...
/// Core error types and result aliases used by Strata.
///
/// This module defines `StrataError` and `Result<T>`, which are re-exported at
/// the crate root for ergonomic use in downstream crates.
pub mod error;

/// Logging initialization for the Strata ecosystem.
///
